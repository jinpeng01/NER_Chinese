...
class Utils:
    ...
    def Buildvocab(self):
        self.vocab = []
        if(os.path.exists(dir+'/word_to_int_table.txt') and os.path.exists(dir+'/int_to_word_table.txt')):
            word_to_int_table_file = open(dir+'/word_to_int_table.txt', 'r', encoding='utf-8')
            int_to_word_table_file = open(dir+'/int_to_word_table.txt', 'r', encoding='utf-8')
            ...
            word_to_int_table_file = open(dir+'/word_to_int_table.txt','w',encoding='utf-8')
            int_to_word_table_file = open(dir+'/int_to_word_table.txt','w',encoding='utf-8')
    ...
    def BuildTarget_vocab(self):
        self.target_vocab = []
        if (os.path.exists(dir+'/target_to_int_table.txt') and os.path.exists(dir+'/int_to_target_table.txt')):
            target_to_int_table_file = open(dir+'/target_to_int_table.txt', 'r', encoding='utf-8')
            int_to_target_table_file = open(dir+'/int_to_target_table.txt', 'r', encoding='utf-8')
            ...
            target_to_int_table_file = open(dir+'/target_to_int_table.txt', 'w', encoding='utf-8')
            int_to_target_table_file = open(dir+'/int_to_target_table.txt', 'w', encoding='utf-8')
            with open(self.filename, 'r', encoding='utf-8') as file:
                for line in file.readlines():
                    line = line.strip()
                    if (len(line) > 1):
                        items = line.split()
                        self.target_vocab.append(items[1])
    ...
    def BuildOther_vocab(self):
        self.other_vocab = []
        if (os.path.exists(dir+'/other_to_int_table.txt') and os.path.exists(dir+'/int_to_other_table.txt')):
            other_to_int_table_file = open(dir+'/other_to_int_table.txt', 'r', encoding='utf-8')
            int_to_other_table_file = open(dir+'/int_to_other_table.txt', 'r', encoding='utf-8')
            ...
            other_to_int_table_file = open(dir+'/other_to_int_table.txt', 'w', encoding='utf-8')
            int_to_other_table_file = open(dir+'/int_to_other_table.txt', 'w', encoding='utf-8')
            with open(self.filename, 'r', encoding='utf-8') as file:
                for line in file.readlines():
                    line = line.strip()
                    if (len(line) > 2):
    ...
    with open(fileName, 'r', encoding='utf-8') as file:
        for line in file.readlines():
            ...
            if(len(items)>1 and items[0] !='.'):
                ...
                target_list_item.append(items[1])

            else:
                if(len(word_list_item)!= 0):
                    print('word_list_item: ', len(word_list_item))
...
# U = Utils(filename='./risk_UtilsData/train.txt')
batch_generator(20,fileName='./risk_UtilsData/train.txt')
